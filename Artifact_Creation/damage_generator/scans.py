...
from damage_generator.helpers import pad_to_size, points_to_contours, sorted_alphanumeric
from damage_generator.unit_converter import PixelToMicron
...
def load_scans(scan_dir, verbose=True):
    ...
    for img_filename in sorted_alphanumeric(os.listdir(scan_dir)):
        if img_filename.endswith(".jpg"):
            ...
            print('Loading dust scan ', scan_dir+img_filename)
