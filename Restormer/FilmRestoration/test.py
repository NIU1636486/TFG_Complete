...
parser.add_argument('--yaml', default='/hhome/priubrogent/tfg/Restormer/Film_Restormer.yml', type=str, help='Path to yaml file')
...
factor = 16
datasets = ['restormerFilmBO_test']

for dataset in datasets:

    result_dir  = os.path.join(args.result_dir, args.weights.split('/')[-1].split('.')[0], dataset)
