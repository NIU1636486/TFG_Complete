...
![Restoration Overview](images/two_stage_pipeline_overview.png)
...
![Artifacts Example](images/artifact_examples.png)
*Examples of synthetic artifacts added: dust, dirt, hair, scratches.*

![Pipeline](images/modular_pipeline.png)
...
![Restormer Architecture](images/restormer_architecture.png)
...
While Restormer excels on synthetic benchmarks, the modular pipeline demonstrates superior generalization on real scans by selectively inpainting damage without disturbing film grain.
